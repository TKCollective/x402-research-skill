...
.r-head{display:flex;justify-content:space-between;font-family:'JetBrains Mono',monospace;font-size:.7rem;letter-spacing:.14em;color:#8a7c5e;border-bottom:1px dashed var(--line-l);padding-bottom:12px;margin-bottom:14px}
.r-body{font-family:'JetBrains Mono',monospace;font-size:.8rem;line-height:1.85;min-height:216px;color:#3a3222}
