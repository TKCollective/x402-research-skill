...
<header class="top">
  <div class="container">
    <nav class="nav">
      ...
      <div class="links">
        <a href="/article-12">Article 12 Tool</a>
...
<div class="paper-header">
  ...
  <div class="meta">
    ...
    Version 1.2 · Revised 2026-07-21 · <a href="https://agentoracle.co">agentoracle.co</a> · <a href="mailto:joe@agentoracle.co">joe@agentoracle.co</a>
  </div>
...
<p>The author thanks Pote (poteshniy) of <a href="https://agenttrust.uk">AgentTrust (agenttrust.uk)</a> for producing the first external byte-identical implementation of the <code>verification.v0.3</code> composed-envelope format. That implementation was merged into argentum-core — an unaffiliated maintainer's specification repository — as pull request #33 on 2026-07-16, and reproduces the canonical bytes and signature verification of the reference verifier vector-for-vector across the Phase 1 and Phase 2 conformance suites. Independent re-implementation from a published specification is the operational meaning of "standards-track"; his willingness to build a second verifier from the spec alone is the reason the claim "the format is publicly and normatively specified, versioned, and open to technical challenge" (§3.4) is not self-referential. AgentTrust's capability-scope signing additionally operates as the co-signer in the two-signer production composition described in §4.</p>
...
<ol class="refs">
  ...
  <li><span class="num">[3]</span> ERC-8210: Agent Assurance — Receipt Profile Registry discussion (registry entry: verification.v0.3). <a href="https://ethereum-magicians.org/t/erc-8210-agent-assurance/28097">ethereum-magicians.org/t/erc-8210-agent-assurance/28097</a></li>
