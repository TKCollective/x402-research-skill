...
<p>The paper describes an alternative that is implemented and publicly specified today: cryptographically signed verification records ("receipts") built entirely from open standards — JSON canonicalization (RFC 8785), JSON Web Signatures (RFC 7515) with Ed25519 keys (RFC 8037), and published key sets (RFC 7517) — and defined normatively in an IETF Internet-Draft, draft-krausz-verification-state. The format is the <a href="https://github.com/wangbin9953/erc8210-aap/pull/4">first registered profile</a> in the Receipt Profile Registry of ERC-8210 (Agent Assurance), a draft Ethereum standard under active development — the profile entry was merged by the ERC author on 2026-06-23 — and has multiple independent implementations. Records in this format are tamper-evident, carry their timestamp inside the signed payload, and can be verified offline by any third party — including a regulator or auditor — without trusting or contacting the operator that produced them.</p>
...
<div class="author-box">
  ...
  <p style="margin-bottom:0">Joe Krausz is the founder of AgentOracle (TK Collective LLC), author of draft-krausz-verification-state, and contributor of the <a href="https://github.com/wangbin9953/erc8210-aap/pull/4">first registered profile</a> in the ERC-8210 Receipt Profile Registry. AgentOracle provides pre-action factual-claim verification for AI systems, with signed receipts in the format this paper describes. Contact: <a href="mailto:joe@agentoracle.co">joe@agentoracle.co</a>.</p>
</div>
