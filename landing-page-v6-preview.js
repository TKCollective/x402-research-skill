...
export const LANDING_PAGE_V6_HTML = `<!DOCTYPE html>
...
.who-uses__card--cta { background: linear-gradient(180deg, rgba(201,169,110,0.06), rgba(201,169,110,0.02)); border-color: rgba(201,169,110,0.25); grid-column: 2 / 3; }
@media (max-width: 920px) { .who-uses__card--cta { grid-column: auto; } }
    ...
    <div class="eval-stage">
      ...
      <div class="eval-pipeline" id="pipeline">
        ...
        <div class="pipeline-line" data-line="2">
          ...
          <span class="pipeline-line__source"></span>
          <span class="pipeline-line__msg">querying <span>4 independent models</span> in parallel</span>
        </div>
...
<div class="data-bar">
  <div class="data-bar__inner">
    ...
    <div class="data-cell">
      ...
      <span class="data-cell__sub">4 independent models</span>
    </div>
    <div class="data-cell">
...
<!-- ========================================================================
     RECOMPUTE DEMO SECTION (v5 add) — buyer-facing invitation up top,
     precise technical recompute chain underneath. This is the strongest
     single proof point on the page: an evaluator hits one URL, runs four
...
<section class="verify-strip" id="receipts">
  <div class="verify-strip__inner">
    ...
    <div class="verify-strip__grid">
      ...
      <a class="verify-card" href="https://pypi.org/project/agentoracle-receipt-verify/" target="_blank" rel="noopener noreferrer">
        <span class="verify-card__label">Working Code · Three Languages</span>
        <span class="verify-card__title">Verify in Node, Python, or the browser</span>
        <span class="verify-card__desc">Byte-identical JCS canonicalization + Ed25519 verify across three implementations. No AgentOracle service required.</span>
        <span class="verify-card__mono">pip install agentoracle-receipt-verify</span>
        <span class="verify-card__arrow">View on PyPI →</span>
      </a>
    </div>
    <div class="proof-tier-grid">
      ...
      <div class="proof-tier">
        <span class="proof-tier__label">Independently certified</span>
        <ul class="proof-tier__list">
  ...
  <div class="reveal">
    ...
    <div class="who-uses__grid">
      <div class="who-uses__card">
        ...
        <a href="/article-12" style="display:inline-block;margin-top:14px;padding:8px 14px;background:rgba(201,169,110,0.1);border:1px solid rgba(201,169,110,0.35);border-radius:6px;color:var(--gold);font-size:13px;text-decoration:none;font-family:var(--font-mono);">Free tool: Article 12 Considerations →</a>
      </div>
      <div class="who-uses__card">
        <div class="who-uses__role">Brand &amp; Content Teams</div>
        <p>Pre-publication fact-check for AI-generated copy. Augment your fact-check process and hand legal a signed audit trail, not a screenshot.</p>
      </div>
      <div class="who-uses__card">
...
<section class="section features-section" id="features">
  ...
  <div class="features-ledger">
    ...
    <div class="feature-row reveal">
      ...
      <span class="feature-row__desc">Four independent research models run in parallel. Consensus builds the score. Contradiction flags the risk.</span>
    </div>
    <div class="feature-row reveal">
      ...
      <div class="feature-row__metric"><div class="feature-row__metric-bar"><div class="feature-row__metric-fill" style="width:100%;"></div></div><span class="feature-row__metric-value">multi-chain</span></div>
    </div>
    <div class="feature-row reveal">
      <span class="feature-row__num">04</span>
      <span class="feature-row__title">Source reputation</span>
      <span class="feature-row__desc">Every domain accumulates a trust score from verified claim history. Query the live index at <a href="/reputation" target="_blank" rel="noopener" style="color:var(--gold);text-decoration:none;font-family:var(--font-mono);font-size:14px;">GET /reputation</a> before using any source.</span>
    </div>
    <div class="feature-row reveal">
      <span class="feature-row__num">05</span>
      <span class="feature-row__title">Feedback flywheel</span>
      <span class="feature-row__desc">Agents report outcomes via <a href="/reputation" target="_blank" rel="noopener" style="color:var(--gold);text-decoration:none;font-family:var(--font-mono);font-size:14px;">POST /feedback</a>. Reputation scores refresh from these signals — the model improves for every agent on the network.</span>
    </div>
  </div>
</section>
...
<section class="banner">
  <div class="banner__inner reveal">
    ...
    <div class="banner__cta-row">
      <a href="/business" class="btn btn--primary">Talk to us about a pilot →</a>
      <a href="#playground" class="hero__sub-link" style="align-self:center;">or try /preview free →</a>
    </div>
  </div>
</section>
...
<!-- USE-CASES SECTION REMOVED v5 (overlapping with who-uses personas section + pricing tier examples)
     Per finalization brief 2026-06-30: merge the two overlapping use-case sections.
     The who-uses section (above) covers buyer personas; pricing tiers (below) covers cost
     examples. This middle vignette grid duplicated both without adding net new information.
...
<section class="section" id="pricing" style="position:relative;z-index:2;">
  <div style="max-width:1240px;margin:0 auto;padding:0 40px;">
    ...
    <div class="reveal" style="max-width:960px;margin:48px 24px 0;padding:36px 32px;border:1px solid var(--gold-dim);border-radius:14px;background:linear-gradient(160deg, rgba(201,169,110,0.04), var(--surface));box-sizing:border-box;overflow-wrap:anywhere;">
      <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:flex-start;gap:24px;">
        <div style="flex:1;min-width:0;">
          ...
          <h3 style="font-size:20px;font-weight:600;margin:0 0 8px;color:var(--text);overflow-wrap:break-word;">Platform-tier pricing &mdash; integrating verification at scale</h3>
          ...
          <p style="font-size:13px;color:var(--text-muted);margin:0;line-height:1.6;">Open-source verifier client on npm: <a href="https://github.com/TKCollective/agentoracle-receipt-verify" target="_blank" rel="noopener noreferrer" style="color:var(--gold);text-decoration:none;border-bottom:1px dashed var(--gold-dim);white-space:nowrap;"><code style="font-family:var(--font-mono);font-size:12px;">@agentoracle<wbr>/receipt-verify</code></a> &mdash; your end users get the same offline cryptographic guarantees regardless of which platform issued the receipt.</p>
        </div>
...
<!-- CREDENTIALS SECTION REMOVED v5 (redundant with Verify-the-verifier proof tier grid above)
     Per finalization brief 2026-06-30: consolidate redundant proof sections into one.
     The six artifacts (IETF draft, receipt spec, reference verifier, AVeriTeC benchmark,
     AgentTrust peer-audit, Coinbase Bazaar) are all already surfaced in the
     proof-tier-grid in the Verify-the-verifier section above. Removing the duplicate
     card grid keeps the proof story single-source-of-truth.
...
<section class="section section--alt" id="specs" style="position:relative;z-index:2;">
  <div style="max-width:1240px;margin:0 auto;padding:0 40px;">
    ...
    <div class="specs-grid reveal">
      ...
      <div class="spec-item"><span class="spec-item__label">Research Engine</span><span class="spec-item__value">Multi-model consensus</span></div>
      <div class="spec-item"><span class="spec-item__label">Endpoints</span><span class="spec-item__value">/preview (free) &middot; /evaluate (free beta) &middot; /research ($0.02) &middot; /deep-research ($0.10)</span></div>
...
<!-- COMPARISON TABLE REMOVED v5 (off-brand punch-up + dated "as of May 2026")
     Per finalization brief 2026-06-30: cut entire competitor comparison section.
<section class="section" id="compare" style="position:relative;z-index:2;">
  <div style="max-width:1240px;margin:0 auto;padding:0 40px;">
    ...
    <p style="font-family:var(--font-mono);font-size:11px;color:var(--text-faint);text-align:center;margin-top:16px;">Comparison based on publicly available pricing and documentation as of May 2026.</p>
  </div>
</section>
-->
