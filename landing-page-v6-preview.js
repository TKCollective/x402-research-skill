    ...
    <div class="reveal" style="max-width:960px;margin:48px 24px 0;padding:36px 32px;border:1px solid var(--gold-dim);border-radius:14px;background:linear-gradient(160deg, rgba(201,169,110,0.04), var(--surface));box-sizing:border-box;overflow-wrap:anywhere;">
      <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:flex-start;gap:24px;">
        <div style="flex:1;min-width:0;">
          ...
          <p style="font-size:13px;color:var(--text-muted);margin:0;line-height:1.6;">Open-source verifier on PyPI: <a href="https://pypi.org/project/agentoracle-receipt-verify/" target="_blank" rel="noopener noreferrer" style="color:var(--gold);text-decoration:none;border-bottom:1px dashed var(--gold-dim);white-space:nowrap;"><code style="font-family:var(--font-mono);font-size:12px;">pip install agentoracle-receipt-verify</code></a> &mdash; your end users get the same offline cryptographic guarantees regardless of which platform issued the receipt.</p>
        </div>
