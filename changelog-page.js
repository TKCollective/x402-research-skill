...
<style>
:root{--ink:#14110a;--paper:#f4eee0;--paper2:#fbf7ec;--gold:#d4a94a;--line:#ddd3bc;--mut:#6b5f47}
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:'Space Grotesk',sans-serif;background:var(--paper);color:var(--ink);line-height:1.65}
.mono{font-family:'JetBrains Mono',monospace}
a{color:inherit}
nav{border-bottom:1px solid var(--line);background:var(--paper2)}
...
ol{list-style:none}
li{border-left:2px solid var(--gold);padding:2px 0 34px 26px;position:relative}
...
li p{font-size:.93rem;color:#4a4130;max-width:620px}
</style>
</head>
<body>
...
<main>
  ...
  <ol>
    <!-- 9 dated items transplanted from landing-page-v6-preview.js whatsNewTrack, newest first. -->
    <li>
