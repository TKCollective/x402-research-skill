  ...
  <div style="max-width:1240px;margin:0 auto;padding:0 40px;">
    <div class="mcp-grid reveal">
      <div>
        ...
        <p style="font-size:15px;color:var(--text-muted);line-height:1.7;margin-bottom:20px;">Connect AgentOracle to any MCP-compatible client with a single command. No integration code required.</p>
...
<section class="bottom-cta section" style="position:relative;z-index:2;">
  <div style="max-width:1240px;margin:0 auto;padding:0 40px;text-align:center;">
    <h2 class="bottom-cta__headline reveal">Start querying in <span class="gold-text">seconds</span></h2>
    <p class="bottom-cta__sub reveal">One endpoint. One payment. Trust verification for your agent. No setup required.</p>
